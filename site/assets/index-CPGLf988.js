(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e=e=>`./${e}`,t={version:7,resort:{name:`Hotel Resto Deu Lagoa Uruau`,tagline:`Hotel, restaurante e vista para a lagoa em Uruau.`,heroTitle:`Hotel, restaurante e lagoa na mesma paisagem.`,heroCopy:`Esta versao publica usa apenas informacoes que puderam ser confirmadas a partir do Instagram oficial e da referencia geografica publica da Lagoa do Uruau. Catalogo detalhado, tarifas e politicas seguem editaveis no painel para homologacao com a pousada.`,storyTitle:`A marca publica se apresenta como hotel e restaurante com foco na lagoa.`,storyCopy:`O objetivo desta entrega e separar o que ja esta confirmado em fonte publica do que ainda precisa ser preenchido pela operacao. Assim o site fica bonito, vendavel e tecnicamente honesto.`,location:`Lagoa do Uruau, Beberibe - Ceara`,reservationPhone:``,reservationWhatsapp:``,reservationEmail:``,checkIn:`sob consulta`,checkOut:`sob consulta`,seasonLabel:`Hotel + Restaurante | Lagoa do Uruau`,sellerCode:`deulagoa2026`,heroImage:e(`deu-lagoa/hero-lagoa-hq.jpg`),profileImage:e(`deu-lagoa/perfil.jpg`),signatureImage:e(`deu-lagoa/resto-noite-hq.jpg`),culinaryImage:e(`deu-lagoa/suite-casal-hq.jpg`),featureVideo:e(`deu-lagoa/lagoa-cinema.mp4`),featureVideoPoster:e(`deu-lagoa/hero-lagoa-hq.jpg`),instagramHandle:`@deulagoauruau`,instagramUrl:`https://www.instagram.com/deulagoauruau/`},stats:[{value:`Hotel`,label:`o perfil oficial apresenta a marca como hotel`},{value:`Resto`,label:`o mesmo perfil tambem comunica restaurante`},{value:`Lagoa`,label:`a vista para a lagoa aparece na bio publica`},{value:`Uruau`,label:`a referencia territorial da marca e Uruau`}],storyPanels:[{id:`story-1`,eyebrow:`fonte publica`,title:`O principal ativo visual confirmado e a lagoa.`,copy:`A bio oficial fala em vista encantadora da lagoa, e as imagens publicas reforcam essa leitura como centro da experiencia.`,image:e(`deu-lagoa/hero-lagoa-hq.jpg`)},{id:`story-2`,eyebrow:`identidade`,title:`Hotel e restaurante aparecem juntos na apresentacao da marca.`,copy:`Isso permite um site institucional mais forte, com reserva assistida e uma narrativa que integra hospedagem e mesa sem inventar detalhes operacionais.`,image:e(`deu-lagoa/resto-noite-hq.jpg`)},{id:`story-3`,eyebrow:`homologacao`,title:`Tarifas, tipos de quarto e politicas ficam no painel ate validacao da operacao.`,copy:`A interface publica evita prometer informacoes que nao foram confirmadas e o painel segue pronto para receber o inventario oficial.`,image:e(`deu-lagoa/suite-casal-hq.jpg`)}],suites:[{slug:`consulta-hospedagem`,name:`Consulta de hospedagem`,category:`canal direto`,rate:0,size:``,guests:0,beds:``,image:e(`deu-lagoa/suite-casal-hq.jpg`),gallery:[e(`deu-lagoa/suite-casal-hq.jpg`),e(`deu-lagoa/hero-lagoa-hq.jpg`),e(`deu-lagoa/resto-noite-hq.jpg`)],summary:`O perfil oficial confirma hospedagem na Deu Lagoa, mas o inventario publico detalhado nao estava disponivel sem login ou contato direto.`,details:`Esta categoria funciona como estrutura institucional para a vitrine. A pousada pode substituir por suites reais, tarifas e regras oficiais diretamente no painel vendedor.`,amenities:[]},{slug:`consulta-experiencia`,name:`Experiencia integrada`,category:`hotel e restaurante`,rate:0,size:``,guests:0,beds:``,image:e(`deu-lagoa/resto-noite-hq.jpg`),gallery:[e(`deu-lagoa/resto-noite-hq.jpg`),e(`deu-lagoa/hero-lagoa-hq.jpg`),e(`deu-lagoa/familia-hq.jpg`)],summary:`A comunicacao publica posiciona hotel e restaurante como parte da mesma identidade.`,details:`A operacao pode transformar este bloco em pacote, experiencia ou categoria real assim que houver dados homologados sobre consumo, inclusoes e disponibilidade.`,amenities:[]}],rituals:[{title:`Fonte publica primeiro`,copy:`Tudo que aparece como fato na vitrine precisa estar sustentado por fonte publica ou validacao direta da pousada.`},{title:`Painel separado`,copy:`Dados operacionais ficam no vendedor para serem preenchidos e aprovados sem contaminar a area publica com suposicoes.`},{title:`Reserva com bloqueio`,copy:`O sistema ja trata pendencia, confirmacao e cancelamento para evitar sobreposicao de datas na mesma categoria cadastrada.`}],experiences:[{id:`exp-1`,name:`Hotel e Restaurante`,duration:`bio oficial`,description:`O perfil publico apresenta a marca como hotel e restaurante.`},{id:`exp-2`,name:`Vista encantadora da lagoa`,duration:`bio oficial`,description:`A lagoa aparece como elemento central da experiencia comunicada publicamente.`},{id:`exp-3`,name:`Experiencias, sabores e conforto`,duration:`bio oficial`,description:`Essa e a frase publica que resume a promessa atual da marca no Instagram.`},{id:`exp-4`,name:`Reservas e mais informacoes`,duration:`bio oficial`,description:`O perfil indica canal de reservas, mas sem exibir publicamente telefone e e-mail completos nesta verificacao.`}],itinerary:[{time:`perfil`,title:`Hotel e restaurante`,description:`A apresentacao publica deixa claro que hospedagem e mesa fazem parte da mesma oferta.`},{time:`bio`,title:`Vista para a lagoa`,description:`A lagoa e o principal ativo territorial identificado na comunicacao oficial observada em 02 de abril de 2026.`},{time:`bio`,title:`Experiencias, sabores e conforto`,description:`A mensagem publica trabalha atmosfera e experiencia, sem detalhar ainda catalogo ou politicas comerciais.`},{time:`site`,title:`Pre-reserva assistida`,description:`O fluxo do site registra interesse, bloqueia datas e prepara o terreno para a confirmacao da equipe.`}],testimonials:[{quote:`Hotel e Restaurante`,author:`bio oficial`},{quote:`Vista encantadora da lagoa`,author:`bio oficial`},{quote:`Experiencias, sabores e conforto`,author:`bio oficial`}],faq:[{question:`As tarifas mostradas no site ja sao oficiais?`,answer:`Nao. Esta versao publica evita expor precos nao confirmados. O painel vendedor esta pronto para cadastrar valores reais assim que a pousada homologar o catalogo.`},{question:`A reserva e confirmada automaticamente?`,answer:`Nao. O site registra uma pre-reserva, bloqueia datas em status pendente e encaminha o atendimento para confirmacao final.`},{question:`Quais dados foram realmente validados?`,answer:`Nome do perfil, handle, bio publica e o vinculo territorial com a Lagoa do Uruau em Beberibe. Contatos e politicas seguem pendentes de validacao direta.`},{question:`O painel ja esta pronto para operacao real?`,answer:`A interface e o fluxo estao prontos. Para producao, o proximo passo e ligar o sistema a um backend com autenticacao e banco SQL.`}],policies:[`Somente fatos publicos verificados entram na vitrine por padrao.`,`Contatos, tarifas e politicas oficiais devem ser homologados no painel.`,`Pre-reserva no site nao substitui confirmacao final da equipe.`,`Instagram oficial e a fonte publica principal validada nesta entrega.`],instagramPosts:[{id:`ig-1`,image:e(`deu-lagoa/hero-lagoa-hq.jpg`),caption:`Imagem publica usada para reforcar a lagoa como eixo visual da marca.`},{id:`ig-2`,image:e(`deu-lagoa/resto-noite-hq.jpg`),caption:`Imagem publica alinhada ao posicionamento de hotel e restaurante.`},{id:`ig-3`,image:e(`deu-lagoa/suite-casal-hq.jpg`),caption:`Imagem publica de ambiente de hospedagem, sem inventario detalhado associado.`},{id:`ig-4`,image:e(`deu-lagoa/familia-hq.jpg`),caption:`Imagem publica de convivencia usada para sustentar a leitura de experiencia e conforto.`},{id:`ig-5`,image:e(`deu-lagoa/inauguracao-hq.jpg`),caption:`Imagem publica institucional reaproveitada como material de marca.`},{id:`ig-6`,image:e(`deu-lagoa/lagoa.jpg`),caption:`Imagem publica de paisagem usada para reforcar a narrativa territorial.`}],reservations:[],reservationSettings:{blockingStatuses:[`pending`,`confirmed`],leadExpiryHours:24},verification:{checkedAt:`2026-04-02`,verifiedFacts:[{id:`vf-1`,label:`O perfil oficial usa o nome Hotel Resto Deu Lagoa Uruau e o handle @deulagoauruau.`,sourceLabel:`Instagram oficial`,sourceUrl:`https://www.instagram.com/deulagoauruau/`},{id:`vf-2`,label:`A bio publica traz as linhas Hotel & Restaurante, Vista encantadora da lagoa e Experiencias, sabores e conforto.`,sourceLabel:`Instagram oficial`,sourceUrl:`https://www.instagram.com/deulagoauruau/`},{id:`vf-3`,label:`A Lagoa do Uruau esta em Beberibe, Ceara.`,sourceLabel:`Semace`,sourceUrl:`https://www.semace.ce.gov.br/2021/05/26/lagoa-do-urau-operacao-de-fiscalizacao-da-semace-e-bpma-resulta-em-embargos-e-auto-de-infracao/`}],pendingValidation:[`Telefone operacional`,`WhatsApp comercial`,`E-mail oficial de reservas`,`Tipos reais de quarto`,`Tarifas oficiais`,`Politicas financeiras e de cancelamento`]},ops:{stack:[{title:`Banco de dados`,description:`PostgreSQL com bloqueio transacional por periodo e estrutura para multiusuario.`},{title:`Aplicacao`,description:`Frontend institucional com painel vendedor separado da vitrine publica.`},{title:`API`,description:`Camada REST ou Supabase para reservas, autenticacao, auditoria e midia.`},{title:`Operacao`,description:`Fluxo de aprovacao, calendario, notificacoes, logs e backups.`}],bookingFlow:[{step:`01`,title:`Pre-reserva`,description:`O comprador envia interesse com nome, contato, categoria e periodo desejado.`},{step:`02`,title:`Bloqueio temporario`,description:`Status pendente e confirmado impedem dupla venda no mesmo intervalo cadastrado.`},{step:`03`,title:`Homologacao operacional`,description:`A equipe confirma valores, politica, pagamento e disponibilidade final.`}],launchChecklist:[`Conectar o painel a Postgres ou Supabase antes da venda final.`,`Validar contatos oficiais com a pousada e preencher o painel com dados reais.`,`Configurar autenticacao real para vendedor, sem depender de codigo estatico.`,`Salvar reservas com auditoria e historico de alteracoes.`,`Ativar backups, politica LGPD e monitoramento de erros.`]},meta:{updatedAt:`2026-04-02T18:00:00.000Z`,persistence:`localStorage-demo`}},n=[`pending`,`confirmed`];function r(e){let t=e?.reservationSettings?.blockingStatuses;return Array.isArray(t)&&t.length?t:n}function i(e,t){return r(e).includes(String(t?.status||``).toLowerCase())}function a(e,t,n=``){let r=String(t?.suiteSlug||``),a=String(t?.checkin||``),s=String(t?.checkout||``);return!r||!a||!s?!1:o(e,r).some(t=>n&&t.id===n||!i(e,t)?!1:u(a,s,t.checkin,t.checkout))}function o(e,t){return(e?.reservations||[]).filter(e=>e.suiteSlug===t).slice().sort((e,t)=>String(e.checkin||``).localeCompare(String(t.checkin||``)))}function s(e,t,n=3){let r=d(new Date().toISOString().slice(0,10));return o(e,t).filter(t=>i(e,t)).filter(e=>d(e.checkout)>=r).slice(0,n)}function c(e,t=90){let n=e?.suites||[],r=e?.reservations||[],a=n.length||1,o=new Date;o.setHours(0,0,0,0);let s=new Date(o);s.setDate(s.getDate()+t);let c=0,l=0,u=0;r.forEach(t=>{if(String(t.status||``)===`pending`&&(l+=1),!i(e,t))return;u+=1;let n=Math.max(d(t.checkin),Math.floor(o.getTime()/864e5)),r=Math.min(d(t.checkout),Math.floor(s.getTime()/864e5));r>n&&(c+=r-n)});let f=a*t;return{suiteCount:a,reservationCount:r.length,activeCount:u,pendingCount:l,blockedNights:c,occupancyRate:f?Math.min(100,Math.round(c/f*100)):0}}function l(e){return{id:String(e?.id||``),suiteSlug:String(e?.suiteSlug||``),guestName:String(e?.guestName||``),guestContact:String(e?.guestContact||``),guestEmail:String(e?.guestEmail||``),checkin:String(e?.checkin||``),checkout:String(e?.checkout||``),guests:Number(e?.guests||1),notes:String(e?.notes||``),status:String(e?.status||`pending`),source:String(e?.source||`site`),totalEstimate:Number(e?.totalEstimate||0),createdAt:String(e?.createdAt||new Date().toISOString())}}function u(e,t,n,r){let i=d(e),a=d(t),o=d(n),s=d(r);return!Number.isFinite(i)||!Number.isFinite(a)||!Number.isFinite(o)||!Number.isFinite(s)?!1:i<s&&o<a}function d(e){if(!e)return NaN;let t=new Date(`${e}T12:00:00`).getTime();return Number.isFinite(t)?Math.floor(t/864e5):NaN}function f(e){return new Intl.NumberFormat(`pt-BR`,{style:`currency`,currency:`BRL`,maximumFractionDigits:0}).format(Number(e)||0)}function p(e){let t=Number(e)||0;return`${t} ${t===1?`hospede`:`hospedes`}`}function ee(e,t){if(!e||!t)return 0;let n=new Date(`${e}T12:00:00`),r=new Date(`${t}T12:00:00`).getTime()-n.getTime();return!Number.isFinite(r)||r<=0?0:Math.round(r/864e5)}function m({suite:e,checkin:t,checkout:n,guests:r}){let i=ee(t,n);return{nights:i,total:i*(e?.rate||0),valid:!!(e&&i>0&&r>0)}}function h(e){if(!e)return``;try{return new Intl.DateTimeFormat(`pt-BR`,{day:`2-digit`,month:`short`}).format(new Date(`${e}T12:00:00`))}catch{return e}}function g(e,t){return!e||!t?``:`${h(e)} - ${h(t)}`}function _(e){let t=String(e||``).toLowerCase();return t===`confirmed`?`confirmada`:t===`cancelled`?`cancelada`:t===`completed`?`concluída`:`pendente`}function v(e){return String(e??``).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/\"/g,`&quot;`).replace(/'/g,`&#39;`)}var y=`deu_lagoa_content_v1`;function b(){let e=re(t,te());return x(e),e}function te(){try{let e=localStorage.getItem(y);return e?JSON.parse(e):null}catch{return null}}function x(e){localStorage.setItem(y,JSON.stringify(e))}function ne(){return x(t),S(t)}function S(e){return JSON.parse(JSON.stringify(e))}function re(e,t){if(!t)return S(e);let n=S(e),r=S(t);return n.resort={...n.resort,...r.resort||{}},n.stats=C(r.stats,n.stats),n.storyPanels=C(r.storyPanels,n.storyPanels),n.suites=C(r.suites,n.suites),n.rituals=C(r.rituals,n.rituals),n.experiences=C(r.experiences,n.experiences),n.itinerary=C(r.itinerary,n.itinerary),n.testimonials=C(r.testimonials,n.testimonials),n.faq=C(r.faq,n.faq),n.policies=C(r.policies,n.policies),n.instagramPosts=C(r.instagramPosts,n.instagramPosts),n.reservations=C(r.reservations,n.reservations),n.verification=w(n.verification,r.verification),n.ops=w(n.ops,r.ops),n.reservationSettings=w(n.reservationSettings,r.reservationSettings),n.meta={updatedAt:r?.meta?.updatedAt||new Date().toISOString(),persistence:`localStorage-demo`},n.version=e.version,n}function C(e,t){return S(Array.isArray(e)?e:t)}function w(e,t){if(!t||typeof t!=`object`||Array.isArray(t))return S(e);let n=S(e);return Object.entries(t).forEach(([e,t])=>{Array.isArray(t)?n[e]=S(t):t&&typeof t==`object`?n[e]=w(n[e]||{},t):n[e]=t}),n}var T=document.querySelector(`#app`),E=`deu_lagoa_seller_session_v1`,D={content:b(),route:A(),menuOpen:!1,activeSuite:``,activeGalleryIndex:0,openFaq:``,notice:``,booking:{suite:``,checkin:`2026-04-10`,checkout:`2026-04-13`,guests:2,guestName:``,guestContact:``,guestEmail:``,notes:``},seller:{suiteEditSlug:``,experienceEditId:``,instagramEditId:``,reservationEditId:``}},O,k=0;ie();function ie(){U(),location.hash||(location.hash=`/comprador`),j(),T.addEventListener(`click`,Ke),T.addEventListener(`input`,W),T.addEventListener(`change`,qe),T.addEventListener(`submit`,Je),window.addEventListener(`hashchange`,ae),window.addEventListener(`keydown`,lt),window.addEventListener(`scroll`,$,{passive:!0}),window.addEventListener(`pointermove`,dt,{passive:!0})}function A(){let e=(location.hash.replace(/^#/,``)||`/comprador`).split(`/`).filter(Boolean);return e[0]===`vendedor`?{name:`seller`,tab:[`suites`,`experiencias`,`reservas`,`midia`,`config`,`operacao`].includes(e[1])?e[1]:`login`}:{name:`buyer`}}function ae(){D.route=A(),D.menuOpen=!1,U(),j()}function j(){D.content=b(),U(),T.innerHTML=`
    ...
    <section class="audit-strip section-shell">
      <div class="audit-strip-shell reveal">
        <div class="audit-strip-copy">
          ...
          <p>Informacoes publicas verificadas em ${v(e.checkedAt)}. O restante ficou no painel vendedor como dado operacional a ser homologado pela pousada.</p>
        </div>
        <div class="audit-strip-tags">
          ${e.verifiedFacts.map(e=>`<span>${v(e.sourceLabel)}</span>`).join(``)}
        </div>
      </div>
    </section>
  `}function me(e){let t=Ee(e),n=Array.isArray(e.amenities)&&e.amenities.length>0;return`
  ...
  `}function ve(){let e=D.content.resort;return`
  ...
  `}function be(){let e=D.content.resort,t=D.content.verification;return`
    <footer class="site-footer section-shell">
      <div class="site-footer-shell">
        ...
        <div class="site-footer-meta">
          <span>Auditoria publica: ${v(t.checkedAt)}</span>
  ...
  `}function Se(){let e=c(D.content);return Y()?`
    ...
    <main class="seller-main section-shell seller-shell">
      <section class="seller-kpis reveal">
        ...
        <article><strong>${e.pendingCount}</strong><span>pre-reservas pendentes</span></article>
  ...
  `}function ke(){let e=H(),t=[...D.content.reservations||[]].sort((e,t)=>String(t.createdAt||``).localeCompare(String(e.createdAt||``)));return`
    <section class="seller-grid reveal">
      <article class="seller-panel seller-panel-list">
        ...
        <div class="seller-list">
          ${t.length?t.map(e=>{let t=V(e.suiteSlug);return`<button type="button" class="seller-card ${e.id===D.seller.reservationEditId?`active`:``}" data-edit-reservation="${v(e.id)}"><div><strong>${v(e.guestName||`Sem nome`)}</strong><span>${v(t?.name||e.suiteSlug)}</span></div><small>${v(_(e.status))}</small></button>`}).join(``):`<article class="seller-empty-state"><strong>Sem reservas ainda</strong><p>A primeira pre-reserva criada na vitrine aparecera aqui com bloqueio de datas e status operacional.</p></article>`}
        </div>
      </article>
      <article class="seller-panel seller-panel-form">
